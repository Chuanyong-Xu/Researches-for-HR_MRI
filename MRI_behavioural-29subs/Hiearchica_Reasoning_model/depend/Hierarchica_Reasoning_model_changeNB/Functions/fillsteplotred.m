...
%    md = nanmean(d);
    fill_around_line(m,ste(d),[255/255 51/255 51/255],xrange);
...
elseif ndims(dat)==2;
   m=squeeze(nanmean(dat));
    ...
    hold on; 
    h = plot(m,'color',[255/255 51/255 51/255],'LineWidth',linewid,'linestyle',linez{1});
...
% % % %     fill_around_line(m,ste(dat),[0.4660 0.6740 0.1880]);%*****by xu20230926
    ...
    fill(x_fill,y_fill,[255/255 51/255 51/255],'FaceAlpha',0.2,'EdgeColor','none')
    %*****by xu20230926
