...
function [logLikeSwitch] = logLike_of_pr_switch(Input, switchPam, parameter_strings, psych_parameters, psych_parameter_strings, psych_SubjObj_flag, expectedAccuracy_Benchmark, mOfT);
...
[Output_pr_of_switch, Output_tDev_lastOne, Output_RuleChoice_lastOne, Output_T, Output_SW, mu_switch_estimated] = pr_switch_func(Input, switchPam, parameter_strings, psych_parameters, psych_parameter_strings, psych_SubjObj_flag, expectedAccuracy_Benchmark);
...
%     
%     if switchPam(1)<0.01 | switchPam(2)<0.01 % switchPam(1)>10 | switchPam.switch_bound < 0 | switchPam.sigma_switch < 0  switchPam(2)<0 | 
%         logLikeSwitch = 10000000;
%     end     
