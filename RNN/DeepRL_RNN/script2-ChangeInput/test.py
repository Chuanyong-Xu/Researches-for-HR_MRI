...
from dalaloader import extract_behavioral_data, split_data_by_ratio, RNNInputDataset, reshape_own
from model import RNN
from trian_valid import train_val_loop
...
if __name__ == "__main__":
    ...
    ###### using untrained model to verify the pattern of hidden layer in RNN ######
    #model.load_state_dict(torch.load("../model/untrained_seed42.pt"))
    ...
    all_hidden_state = all_hidden_state.squeeze().cpu().detach().numpy()
